require 'spec_helper'
require 'puppet/util/network_device/transport_ftos/ssh'

describe Puppet::Util::NetworkDevice::Transport_ftos::Ssh, :if => Puppet.features.ssh? do

  before(:each) do
    @transport = Puppet::Util::NetworkDevice::Transport_ftos::Ssh.new()
  end
