...
class PuppetX::Force10::Model::Uplinkstategroup < PuppetX::Force10::Model::Base
  ...
  def mod_path_base
    return 'puppet_x/force10/model/uplinkstategroup'
  end

  def mod_const_base
    return PuppetX::Force10::Model::Uplinkstategroup
  end
