...
class Puppet::Util::NetworkDevice::Dell_ftos::Model::Feature < Puppet::Util::NetworkDevice::Dell_ftos::Model::Base
  ...
  def mod_path_base
    return 'puppet/util/network_device/dell_ftos/model/feature'
  end

  def mod_const_base
    return Puppet::Util::NetworkDevice::Dell_ftos::Model::Feature
  end
