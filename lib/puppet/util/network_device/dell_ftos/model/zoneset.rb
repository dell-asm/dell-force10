...
class Puppet::Util::NetworkDevice::Dell_ftos::Model::Zoneset < Puppet::Util::NetworkDevice::Dell_ftos::Model::Base
  ...
  def mod_path_base
    return 'puppet/util/network_device/dell_ftos/model/zoneset'
  end

  def mod_const_base
    return Puppet::Util::NetworkDevice::Dell_ftos::Model::Zoneset
  end
