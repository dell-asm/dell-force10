Puppet::Type.newtype(:force10_interface) do
  ...
  newproperty(:portchannel) do
    ...
    validate do |value|
      ...
      raise ArgumentError, "'portchannel' vlaue must be between 1-128" unless value.to_i >=1 && value.to_i <= 128
    end
  ...
  newproperty(:mtu) do
    ...
    validate do |value|
      ...
      raise ArgumentError, "'mtu' vlaue must be between 594-12000" unless value.to_i >=594 && value.to_i <= 12000
    end
  end
